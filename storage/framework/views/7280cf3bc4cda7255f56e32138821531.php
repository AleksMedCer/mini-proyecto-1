<?php $__env->startSection('title', 'Crear Cuenta - GoldenWind'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="auth-footer">
            <p>
                ¿Ya tienes cuenta? 
                <a href="<?php echo e(route('login')); ?>" class="link-primary">Inicia sesión aquí</a>
            </p>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/aleksmedcer/Documents/Mini Proyecto 1/resources/views/auth/register.blade.php ENDPATH**/ ?>