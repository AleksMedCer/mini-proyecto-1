...
<div class="auth-container">
    <div class="auth-card">
        ...
        <div class="auth-header">
            ...
            <p>Crea tu cuenta para acceder a nuestros productos y dashboard de cliente</p>
        </div>

        <div class="register-role-note">
            <i class="fas fa-id-badge"></i>
            <div>
                <strong>Rol asignado automáticamente:</strong>
                <span>toda cuenta nueva se registra como <strong>Cliente</strong>. Los roles Empleado y Gerente se administran internamente.</span>
            </div>
        </div>

        <!-- Formulario de Registro - Julio -->
